 ...
 */
public final class ESBException extends Exception implements Serializable {
    ...
    public ESBException(String message, String domain, int code, Throwable cause) {
        super(message, cause);
        this.msg = message;
    ...
    public ESBException(String message, String domain, int code, String reason) {
    ...
    public ESBException setCoreCause(Throwable inner) {
        this.inner = inner;
    ...
    public final ESBAPICode toAPICode() {
        ESBAPICode c = new ESBAPICode();
        c.code = this.code;
        c.domain = this.domain;
        c.name = this.name;
        c.desc = this.getLocalizedMessage();
        return c;
    }
    ...
    public final ESBException addUserInfo(String key, Object obj) {
        if (info == null) {
